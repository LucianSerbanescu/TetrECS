...
public class GameBoard extends GridPane {
    ...
    //Call it when you rightClick
    private RightClickedListener rightClickedListener;

    //private GameBlock.HighlightTimer timer;

    //private final boolean centre = false;

    protected boolean piece;

    //check for keyboard usage
    //private final BooleanProperty keyboard = new SimpleBooleanProperty(false);

    private GameBlock hoverValue;

    private int hoveredX;
    private int hoveredY;
    private GameBlock blockMouseEntered;
    ...
    public GameBoard(int cols, int rows, double width, double height, boolean piece) {
        this.piece = piece;
        this.cols = cols;
        this.rows = rows;
        this.width = width;
    ...
    protected void createBlock(int x, int y) {
        ...
        if(!piece){
            ...
            block.setOnMouseExited((e) -> deHover(block));
        }
    }
    ...
    //For triggering an event when the something is rightClicked
     ...
     * @param block
     */
    public void deHover(GameBlock block) {
     ...
     * @param blockHovered
     */
    public void hover(GameBlock blockHovered) {
        //if it is the first block
        if (hoverValue != null) {
            blockHovered.setHovering(false);
        }
        hoverValue = blockHovered;
        blockHovered.setHovering(true);
    }

    /**
     * pass what block to fade
     * @param x
     * @param y
     */
    public void passTheGameBlockToFade(int x,int y) {
