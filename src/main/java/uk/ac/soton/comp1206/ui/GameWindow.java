...
public class GameWindow {
    ...
    private void setupResources() {
        ...
        Font.loadFont(getClass().getResourceAsStream("/style/Starjedi.ttf"),32);
        Font.loadFont(getClass().getResourceAsStream("/style/STJEDISE.ttf"),32);
        Font.loadFont(getClass().getResourceAsStream("/style/mandalor.ttf"),32);
        Font.loadFont(getClass().getResourceAsStream("/style/DeathStar-VmWB.ttf"),32);
        Font.loadFont(getClass().getResourceAsStream("/style/Moonhouse-yE5M.ttf"),32);
        Font.loadFont(getClass().getResourceAsStream("/style/StarjediSpecialEdition-9Bqy.ttf"),32);
    }
    ...
    //Display Scores
    public void startScores(Game game,boolean isMultiplayer) {
        loadScene(new ScoresScene(this, game, isMultiplayer));
    }
    ...
    public void startMultiplayerLobby() {
        if(!communicator.getSinglePlayerGame()){
            ...
            Alert error = new Alert(Alert.AlertType.ERROR,"This is the single player version of the game \n If you want to access the multiplayer please connect to the VPN");
            error.showAndWait();
        }
    }
